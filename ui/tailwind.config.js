/* eslint @typescript-eslint/explicit-function-return-type: 0, @typescript-eslint/no-var-requires: 0 */

/**
 * This Tailwind config is a copy from the stackrox/rox repo.
 * TODO: consolidate by extracting tailwind stuff into a separate NPM package.
 */
...
module.exports = {
  ...
  variants: {
    ...
    borderCollapse: [],
    borderColor: ['responsive', 'first-child', 'last-child', 'before', 'after', 'hover', 'focus'],
    ...
    fontWeight: ['responsive', 'first-child', 'last-child', 'before', 'after', 'hover', 'focus'],
    ...
    fontSmoothing: ['responsive', 'first-child', 'last-child', 'before', 'after', 'hover', 'focus'],
    textDecoration: [
      'responsive',
      'first-child',
      'last-child',
    ...
    textTransform: ['responsive', 'first-child', 'last-child', 'before', 'after', 'hover', 'focus'],
